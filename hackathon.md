...
2. Truthful delivery and ownership:
   ...
   - Quote-created contractors no longer inherit corpus contacts or fabricated license badges (`not-published@verify-required.invalid`, "Not verified", "Unverified — quote intake"), and A401-style drafts print an honest "contact not published" line.
...
5. Verification:
   ...
   - Deliverable: `docs/audits/audit-6-remediation.html` (self-contained; verification table, before/after evidence, new findings, decisions, BYO proof, regression output, convergence log, honesty section) plus the remediated audit itself at `docs/audits/audit-6-usefulness.html`/`.md`; raw evidence stays local (`evidence/`, `scripts/audit7/`).
