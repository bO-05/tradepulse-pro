...
async function run() {
  ...
  await page.screenshot({ path: path.join(CAPTURE_DIR, "v2_09_judge_dock.png") });
  ...
  await new Promise((r) => setTimeout(r, 1000));
  await page.screenshot({ path: path.join(CAPTURE_DIR, "v2_10_subcontract_inspect.png") });
  ...
  await new Promise((r) => setTimeout(r, 1000));
  await page.screenshot({ path: path.join(CAPTURE_DIR, "v2_11_ingest_quote.png") });
